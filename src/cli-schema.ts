...
export const CLI_COMMANDS: readonly CliCommandDefinition[] = [
  ...
  { usage: "repovista github-status [finding-id|--all] [--run <run-id|dir>] [--json]", name: "github-status", help: "Refresh linked GitHub issue and pull request status for findings" },
